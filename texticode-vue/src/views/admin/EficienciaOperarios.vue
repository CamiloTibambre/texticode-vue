                ...
                >
                  ...
                  <td style="min-width:120px">
                    <div class="carga-bar-wrap">
                      <div class="carga-bar">
                        <div class="carga-bar-fill"
                          :style="{
                            width: cargaBarPct(op.ordenes_activas) + '%',
                            background: cargaColor(op.estado_carga)
                          }"
                        ></div>
                      </div>
...
// ── STATS: calculados directamente de operarios[] ──
...
.switch-btn:not(.active) .switch-badge {
  background: #f1f5f9;
  color: #6b7280;
}
