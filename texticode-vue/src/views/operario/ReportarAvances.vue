    ...
    <main class="main">
      <div class="page-header">
        ...
        <div class="header-stats">
          <div class="hstat">
            <span class="hstat-num blue">{{ ordenesActivas.length }}</span>
            <span class="hstat-lbl">Activas</span>
          </div>
          <div class="hstat-div"></div>
          <div class="hstat">
            <span class="hstat-num green">{{ ordenesCompletadas.length }}</span>
            <span class="hstat-lbl">Completadas</span>
          </div>
          <div class="hstat-div"></div>
          <div class="hstat">
            <span class="hstat-num orange">{{ historial.length }}</span>
            <span class="hstat-lbl">Reportes</span>
          </div>
        </div>
      </div>
