<template>
  <div class="layout">
    ...
    <main class="main">
      <h1 class="title" :class="{ 'fade-in': mounted }">Tareas Asignadas</h1>
      ...
      <div class="stats">
        <div class="stat-card" :class="{ 'card-visible': mounted }" style="transition-delay: 0ms">
          ...
          <div class="stat-number blue">{{ displayEnProceso }}</div>
        </div>
        <div class="stat-card" :class="{ 'card-visible': mounted }" style="transition-delay: 80ms">
          <div class="stat-header">
          ...
          <div class="stat-number green">{{ displayCompletadas }}</div>
        </div>
        <div class="stat-card" :class="{ 'card-visible': mounted }" style="transition-delay: 160ms">
          <div class="stat-header">
          ...
          <div class="stat-number orange">{{ displayPausadas }}</div>
        </div>
        <div class="stat-card" :class="{ 'card-visible': mounted }" style="transition-delay: 240ms">
          <div class="stat-header">
          ...
          <div class="stat-number gray">{{ displayTotal }}</div>
        </div>
      </div>
      ...
      <!-- TAREAS -->
      <div v-else class="tasks-list" :class="{ 'section-visible': mounted }" style="transition-delay: 320ms">
...
.search       { width: 100%; padding: 9px 14px 9px 36px; border-radius: 8px; border: 1px solid #e5e7eb; background: white; font-size: 14px; color: #111827; outline: none; transition: border-color .2s, box-shadow .2s; }
.search:focus { border-color: #1f3a52; box-shadow: 0 0 0 3px rgba(31,58,82,.1); }
.search::placeholder { color: #9ca3af; }
.select       { padding: 9px 12px; border-radius: 8px; border: 1px solid #e5e7eb; background: white; font-size: 14px; color: #374151; cursor: pointer; outline: none; transition: border-color .2s; }
...
.tasks-list.section-visible { opacity: 1; transform: translateY(0); }
...
.task-card:hover { box-shadow: 0 4px 20px rgba(0,0,0,0.07); transform: translateY(-2px); }
...
/* Banda lateral */
.task-stripe { width: 5px; flex-shrink: 0; border-radius: 0; }
