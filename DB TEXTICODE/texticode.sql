...
-- Tiempo de generación: 16-03-2026 a las 15:07:22
...
(1, 'agujas', 'Accesorios', 50, 'unidades', 5, 70, '2026-03-12 06:27:31'),
(2, 'tela', 'Telas', 50, 'metros', 8, 90, '2026-03-12 06:28:06'),
(3, 'Algodon', 'Accesorios', 60, 'metros', 15, 100, '2026-03-12 06:30:23'),
(4, 'llalllll', 'Telas', 2122, '658', 113, 1, '2026-03-12 09:33:15');
...
--
ALTER TABLE `material`
  MODIFY `Id_Material` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identificador único del producto', AUTO_INCREMENT=5;
